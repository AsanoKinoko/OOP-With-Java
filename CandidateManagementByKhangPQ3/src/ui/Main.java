    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 2:
                case 3:
                    List<Candidate> listAddSuccess = candidateManagerController.addCandidateByOptionMenu(choice);
                    System.out.println("List of candidate added success:");
                    for (Candidate c : listAddSuccess) {
                ...
                case 4:
                    List<Candidate> listFound = candidateManagerController.searching();
                ...
                case 5:
                    System.out.println(candidateManagerController.getDisplayStringOfAllCandidate());
                    break;
                case 6: {
                    try {
